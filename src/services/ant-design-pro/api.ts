...
export async function outLogin(options?: { [key: string]: any }) {
  return request<API.RegisterResult>('/api/user/logout', {
    method: 'POST',
    ...(options || {})
  })
}
...
/** 修改接口 POST /api/user/edit */
export async function edit(body: API.editUser, options?: { [key: string]: any }) {
  return request<API.CurrentUser>('/api/user/edit', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
